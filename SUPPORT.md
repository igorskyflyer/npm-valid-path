...
Hello, thank you for using Valid Path! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-valid-path/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-valid-path/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-valid-path/issues) using the appropriate issue template and with the label of `bug`,
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-valid-path/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-valid-path/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Valid Path:
...
<div align="center">
  Thank you for using Valid Path!
  <br>
